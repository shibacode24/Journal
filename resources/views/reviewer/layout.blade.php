    ...
    <div class="page-container page-navigation-top">
        ...
        <div class="page-content">
            ...
            <ul class="x-navigation x-navigation-horizontal">
                ...
                <li>
                    <a href="{{route('reviewer_dashboard')}}" title="Dashboard"><span class="fa fa-desktop"> </span>Dashboard</a>

                </li>
                <li>
                    <a href="{{route('assign_all_menuscript')}}" title="Menuscripts"><span class="fa fa-book"> </span>Assign Menuscripts</a>
                </li>
                <!-- <li>
                    <a href="pending_menuscript.html" title="Published Papers"><span class="fa fa-book"> </span>Pending Menuscripts</a>
                </li> -->
                <li>
                    <a href="{{route('reviewer_notification')}}" title="Published Papers"><span class="fa fa-bell"> </span>Notifications</a>
                </li>
                <li class="xn-icon-button pull-right">
                    <a href="{{route('log_out')}}" class="mb-control" data-box="#mb-signout"><span class="fa fa-sign-out"></span></a>
                </li>
                <li class="xn-icon-button pull-right">
                ...
                <li class="xn-icon-button pull-right" style="margin-right:25px; min-width:100px; color:#FFFFFF; padding-top:20px;">
                    Welcome, Reviewer - {{auth()->user()->first_name}} {{auth()->user()->last_name}}
                </li>
