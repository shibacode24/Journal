                        ...
                        <div class="panel-body" style="padding:1px 5px 2px 5px;">
                            ...
                            <div class="col-md-12" style="margin-top:5px;">
                                <div class="panel panel-default">
                                    <h5 class="panel-title" style="color:#07418F; background-color:#eaeaea; width:100%; font-size:14px;margin-top: 1vh;" align="center">
                                        <i class="fa fa-plus"></i> &nbsp;<b>Add Editor</b></h5>
                                </div>
                            </div>
                            <form action="{{route('create_editor')}}" method="POST">
                                @csrf
                            <div class="col-md-12" style="margin-top:10px;">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="affiliation" value="{{ old('affiliation') }}" placeholder="" />
                                </div>
                                <div class="col-md-2">
                                        ...
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$editors->affiliation}}</td>
                                                    <td>{{$editors->email}}</td>
                                                    <td>
                                                        <a href="{{route('edit_editor',$editors->id)}}">
