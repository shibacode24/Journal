                    ...
                    <div class="col-md-12" style="margin-top:5px;">
                        <div class="panel panel-default">
                            <h5 class="panel-title"
                                ...
                                align="center">
                                <i class="fa fa-plus"></i> &nbsp;<b>Add Category</b>
                            </h5>
                        </div>
                    </div>
                    <form action="{{ route('create_category') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12" style="margin-top:10px;">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="file" class="form-control" name="category_image" placeholder="" />
                            </div>

                            <div class="col-md-2" style="margin-top:15px;">
                                <button id="on" type="submit" class="btn mjks"
                                    style="color:#FFFFFF; height:30px; width:50%;"> <i class="fa fa-plus"></i>Add</button>
                                    ...
                                    <tbody>
                                        @foreach ($category as $categorys)
                                            <tr>
                                                ...
                                                <td>{{ $categorys->category_image }}</td>
                                                <td>
                                                    <a href="{{ route('edit_category', $categorys->id) }}">
                                                        <button
                                                    ...
                                                    <a href="{{ route('delete_category', $categorys->id) }}" onclick="return confirm('Are you sure you want to delete this category?');">
                                                        <button
