...
@include('alert')
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form id="register_Form" action="{{ route('update_paper') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="text" value="{{$added_menuscript->id}}" name="id">
                    ...
                    @endif
                        ...
                        <div class="col-md-12" style="margin-top:10px;">
                            ...
                            <div class="col-md-12" style="margin-top:15px;">
                                <label class="control-label">Referencessss</label>
                                <lable class="error">sfsfsfsd</lable>
...
{{-- <script>
    ...
    if (element.is("textarea")) {
        ...
        error.appendTo(element.closest(".col-md-12").find(".error"));
    } else {
