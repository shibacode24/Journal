    ...
    <div class="page-container page-navigation-top">
        ...
        <div class="page-content">
            ...
            <ul class="x-navigation x-navigation-horizontal">
                ...
                <li>
                    <a href="{{route('editor_dashboard')}}" title="Dashboard"><span class="fa fa-desktop"> </span>Dashboard</a>

                </li>
                <li>
                    <a href="{{route('editor_menuscript')}}" title="Menuscripts"><span class="fa fa-book"> </span>Menuscripts</a>
                </li>

                <li>
                    <a href="{{route('assigned_menuscript')}}" title="Menuscripts"><span class="fa fa-book"> </span>Assigned Menuscripts</a>
                </li>


                <li>
                    <a href="{{route('publish_menuscript')}}" title="Published Menuscripts"><span class="fa fa-book"> </span>Published Menuscripts</a>
                </li>
                <li>
                    <a href="{{route('pending_for_publish_approval')}}" title="Published Menuscripts"><span class="fa fa-book"> </span>Pending for Payment</a>
                </li>
                <li>
                    <a href="{{route('editor_notification')}}" title="Notifications"><span class="fa fa-bell"> </span>Notifications</a>
                </li>

                <!-- <li>
                    <a href="pending_paper.html" title="Pending Papers"><span class="fa fa-book"> </span>Pending Papers</a>
                </li> -->
                ...
                <li class="xn-icon-button pull-right" style="margin-right:25px; min-width:100px; color:#FFFFFF; padding-top:20px;">
                    Welcome,Editor - {{auth()->user()->first_name}} {{auth()->user()->last_name}}
                </li>
